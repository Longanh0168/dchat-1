...
export { plus, inbox, server, discord, friends, nitro, explore, download };
...
export const NitroIcon = ({ width = '24px', height = '24px', className }) => (
    <svg
        className={className}
        width={width}
        height={height}
...
export const PlusIcon = ({ width = '24px', height = '24px', className }) => (
    <svg
        xmlns="http://www.w3.org/2000/svg"
        width={width}
        height={height}
...
export const DiscordIcon = ({ width = '24px', height = '24px', className }) => (
    <svg
        xmlns="http://www.w3.org/2000/svg"
        className={className}
        aria-hidden="true"
